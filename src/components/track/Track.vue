<template>
  <tr class="song">
    <th scope="row">
      <img class="song__image" :srcset="`${track.album.cover_small}, ${track.album.cover_big} 1.5x`" :src="track.album.cover_small" :alt="track.title" width="35px" height="35px" loading="lazy">
    </th>
